...
namespace OwlCore.AbstractUI.ViewModels
{
    ...
    public class AbstractDataListViewModel : AbstractUIViewModelBase
    {
        ...
        private async void Model_ItemsChanged(object sender, System.Collections.Generic.IReadOnlyList<CollectionChangedItem<AbstractUIMetadata>> addedItems, System.Collections.Generic.IReadOnlyList<CollectionChangedItem<AbstractUIMetadata>> removedItems)
        {
